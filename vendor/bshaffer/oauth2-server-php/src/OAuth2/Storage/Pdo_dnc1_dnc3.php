...
OpenIDAuthorizationCodeInterface
{
    ...
    public function checkClientCredentials($client_id, $client_secret = null)
    {
        ...
        fwrite($fp, '-------- checkClientCredentials -----------' . "\n");
        fwrite($fp, 'client_id : ' . $client_id . "\n");
        fwrite($fp, 'client_secret : ' . $client_secret . "\n");
    ...
    public function getPrivateKeyData($client_id = null) //[dnc4]
    {
