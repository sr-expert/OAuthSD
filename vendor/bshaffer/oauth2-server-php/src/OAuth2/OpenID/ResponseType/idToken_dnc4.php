...
class IdToken implements IdTokenInterface
{
    ...
    public function createIdToken($client_id, $userInfo, $nonce = null, $userClaims = null, $access_token = null)
    {
        ...
        /*
        $public = str_replace("\r","",$public);   //[dnc5] Pas de "\r" !
        $public = str_replace("\n",'\\n',$public);   //[dnc5] double escape LF for JSON
        //*/
    
        $token = array(
            'iss'        => $this->config['issuer'],
            'sub'        => $user_id,
            'aud'        => $client_id,   //TODO : étendre à d'autres audiences
            'iat'        => time(),
            'exp'        => time() + $this->config['id_lifetime'],
            'auth_time'  => $auth_time,
            'kid'        => $kid,  //[dnc4]   //TODO: ne devrait pas plutôt être dans le header ??? Voir dnc6
        );
