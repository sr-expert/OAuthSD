...
class Jwt implements EncryptionInterface
{
    ...
    public function urlSafeB64Decode($b64)           // ou : return base64_decode(strtr($b64url, '-_', '+/').str_repeat("=",-strlen($str) & 3)); //see: https://gist.github.com/muffycompo/a378dcfa73c3cf354eb8
    {
