...
* 
* Par rapport à essai1, le jeton d'accès est validé avec la déclaration at_hash 
* du jeton d'identité.
* 
...
// Set session
$state = new_session_start('essai2', SLI_SESSION_DIR);
    ...
    if ( ! isset($_GET['code']) ) {
        ...
        if ( isset($state) ) {
            ...
            if ( $state == decrypt(@$_SESSION['state']) ) {  //[dnc21] 
                ...
                curl_setopt($h, CURLOPT_TIMEOUT, 100);    //100 : DEBUG
