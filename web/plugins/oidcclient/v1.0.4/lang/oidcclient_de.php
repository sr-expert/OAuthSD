...
// C
    ...
    'cfg_lbl_oidcclient_client_secret' => 'Client application Geheimnis',
    ...
    'cfg_inf_oidcclient_scopes' => 'Client application Scopes, durch Leerzeichen getrennt. Beispiel : "openid sli profile"',
